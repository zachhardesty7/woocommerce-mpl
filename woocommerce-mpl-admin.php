    ...
    */
    public static function get_settings() {
        return array(
            ...
            array(
                'id'      => 'add_license_num_checkout_page',
                'name'    => __( 'Add Field for License Number', 'woocommerce-mpl' ),
                'desc'    => __( 'Enable this to add and store a field for license number on the checkout page.', 'woocommerce-mpl' ),
                'default' => 'yes',
                'type'    => 'checkbox'
            ),
            array(
